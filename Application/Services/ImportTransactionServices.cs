...
public class ImportTransactionServices : IImportTransactionsServices
{
    private readonly IBankApiClient _bankApiClient;
    private readonly ApplicationDbContext _dbContext;

    public ImportTransactionServices(IBankApiClient bankApiClient, ApplicationDbContext dbContext)
    {
